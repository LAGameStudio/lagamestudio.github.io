...
function LeftImage( e ) {
  return '<div class="row d_flex"><div class="col-md-6">'
              ...
              +'<h2><span class="blu"></span><a target="_blank" href="'+e.linkback+'">'+e.title+'</a></h2><h4>'
              +'<a target="_blank" href="'+e.channelurl+'">'+e.channel +'</a>'
                  + ' on '+e.date + ' from '+ e.location + '</h4>'
              +'<p>'+e.paragraph+'</p>'
...
function CarouselSetup( e ) {
  ...
  return done+
    ...
    +'<span>'+'<a target="_blank" href="'+e.channelurl+'" style="color:#0F9">'+e.channel +'</a>'+'</span>'
    +'<h4>'+e.title+'</h4>'
    +'<p>'+e.paragraph+'</p>'
    +'<div class="col-sm-col-xl-6 col-lg-6 col-md-6 col-sm-12"><ul class="social_icon">'
    +SocialLI(e.links)
